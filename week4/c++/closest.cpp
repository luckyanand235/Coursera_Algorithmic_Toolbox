...
double minimal_distance1(vector<point> x, vector<point> y){
	...
	vector<point> x_left = x;
	vector<point> x_right = x;
	x_left.erase(x_left.begin() + mid + 1, x_left.end());
	x_right.erase(x_right.begin(), x_right.begin() + mid + 1);
	...
	double d1 = minimal_distance1(x_left, y_left);
	double d2 = minimal_distance1(x_right, y_right);
...
double minimal_distance(vector<long long> x, vector<long long> y){
	...
	double res = minimal_distance1(x_sorted_points, y_sorted_points);
